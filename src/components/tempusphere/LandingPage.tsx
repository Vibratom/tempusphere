...
const mainTools = [
    ...
    { name: 'Education', category: 'Education', icon: BrainCircuit, href: '/education', color: 'bg-amber-500 hover:bg-amber-600', description: 'Create and share interactive learning modules.' },
