...
import { Moon, Sun, Image as ImageIcon, Trash2, Layout, Sidebar, SidebarOpen, Minimize, Palette } from 'lucide-react';
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Label htmlFor="layout-default" className="border rounded-md p-2 has-[:checked]:bg-primary has-[:checked]:text-primary-foreground cursor-pointer">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Label htmlFor="layout-sidebar-left" className="border rounded-md p-2 has-[:checked]:bg-primary has-[:checked]:text-primary-foreground cursor-pointer">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Label htmlFor="layout-sidebar-right" className="border rounded-md p-2 has-[:checked]:bg-primary has-[:checked]:text-primary-foreground cursor-pointer">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Label htmlFor="layout-minimal" className="border rounded-md p-2 has-[:checked]:bg-primary has-[:checked]:text-primary-foreground cursor-pointer">
