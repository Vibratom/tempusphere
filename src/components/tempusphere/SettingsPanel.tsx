  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <RadioGroup value={hourFormat} onValueChange={(value) => setHourFormat(value as '12h' | '24h')}>
      ...
      <div className="space-y-4">
        ...
        <RadioGroup value={primaryClockMode} onValueChange={(value) => setPrimaryClockMode(value as 'digital' | 'analog')}>
          <div className="flex items-center space-x-2">
      ...
      <div className="space-y-4">
        ...
        <RadioGroup value={primaryClockTimezone} onValueChange={(value) => setPrimaryClockTimezone(value as 'local' | 'utc')}>
          <div className="flex items-center space-x-2">
