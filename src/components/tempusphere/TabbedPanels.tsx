...
import { Globe, AlarmClock, Timer, Hourglass, Settings, Scale, Users, CalendarDays, Palette } from 'lucide-react';
...
export const TABS = ['world-clocks', 'alarms', 'stopwatch', 'timer', 'converter', 'planner', 'calendar', 'settings'];
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-5xl flex-1 flex flex-col">
          ...
          <TabsList className="grid w-full grid-cols-4 sm:grid-cols-8 h-auto">
            ...
            <Tooltip>
             ...
             <Tooltip>
              <TooltipTrigger asChild>
                <TabsTrigger value="settings" className="flex-col md:flex-row h-auto gap-2 py-2"><Palette/><span>Appearance</span></TabsTrigger>
              </TooltipTrigger>
          ...
          <TabsContent value="settings" className="animation-fade-in flex-1">
            <Card className="h-full"><SettingsPanel /></Card>
          </TabsContent>
        </Tabs>
    )
}
