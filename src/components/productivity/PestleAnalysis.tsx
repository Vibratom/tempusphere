    ...
    const ExportPreview = () => (
        <div ref={contentRef} className="p-8 bg-background">
            ...
            <div className="grid grid-cols-3 gap-6">
                <PestleColumn title="Political" items={political} placeholder="" icon={Landmark} className="bg-red-100/30 dark:bg-red-900/30 border-red-500" isReadonly/>
                <PestleColumn title="Economic" items={economic} placeholder="" icon={DollarSign} className="bg-green-100/30 dark:bg-green-900/30 border-green-500" isReadonly/>
                <PestleColumn title="Social" items={social} placeholder="" icon={Users} className="bg-blue-100/30 dark:bg-blue-900/30 border-blue-500" isReadonly/>
                <PestleColumn title="Technological" items={technological} placeholder="" icon={Cpu} className="bg-purple-100/30 dark:bg-purple-900/30 border-purple-500" isReadonly/>
                <PestleColumn title="Legal" items={legal} placeholder="" icon={Scale} className="bg-yellow-100/30 dark:bg-yellow-900/30 border-yellow-500" isReadonly/>
                <PestleColumn title="Environmental" items={environmental} placeholder="" icon={Leaf} className="bg-teal-100/30 dark:bg-teal-900/30 border-teal-500" isReadonly/>
            </div>
        </div>
    );
