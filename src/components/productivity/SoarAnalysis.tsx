...
export function SoarAnalysis() {
    ...
    const onDragEnd: OnDragEndResponder = (result) => {
        ...
        const stateMap: Partial<Record<SoarCategory, { items: SoarItem[], setItems: React.Dispatch<React.SetStateAction<SoarItem[]>> }>> = {
        ...
        <DragDropContext onDragEnd={() => {}}>
            <div ref={contentRef} className="p-8 bg-background">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <SoarColumn title="Strengths" category="strengths" items={strengths} placeholder="" icon={Lightbulb} className="bg-green-100/30 dark:bg-green-900/30 border-green-500" isReadonly />
                    <SoarColumn title="Opportunities" category="opportunities" items={opportunities} placeholder="" icon={Rocket} className="bg-blue-100/30 dark:bg-blue-900/30 border-blue-500" isReadonly />
