...
export function ScoreAnalysis() {
    ...
    const onDragEnd: OnDragEndResponder = (result) => {
        ...
        const stateMap: Partial<Record<ScoreCategory, { items: ScoreItem[], setItems: React.Dispatch<React.SetStateAction<ScoreItem[]>> }>> = {
        ...
        <DragDropContext onDragEnd={() => {}}>
            <div ref={contentRef} className="p-8 bg-background">
                ...
                <div className="grid grid-cols-3 gap-6">
                    <ScoreColumn title="Strengths" category="strengths" items={strengths} placeholder="" icon={Lightbulb} className="bg-green-100/30 dark:bg-green-900/30 border-green-500" isReadonly />
