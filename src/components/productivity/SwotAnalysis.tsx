...
export function SwotAnalysis() {
    ...
    const onDragEnd: OnDragEndResponder = (result) => {
        ...
        const stateMap: Record<SwotCategory, { items: SwotItem[], setItems: React.Dispatch<React.SetStateAction<SwotItem[]>> }> = {
        ...
        <DragDropContext onDragEnd={() => {}}>
            <div ref={contentRef} className="p-8 bg-background">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <SwotColumn title="Strengths" category="strengths" items={strengths} placeholder="" className="bg-green-100/30 dark:bg-green-900/30 border-green-500" isReadonly={true} />
                    <SwotColumn title="Weaknesses" category="weaknesses" items={weaknesses} placeholder="" className="bg-red-100/30 dark:bg-red-900/30 border-red-500" isReadonly={true} />
                    <SwotColumn title="Opportunities" category="opportunities" items={opportunities} placeholder="" className="bg-blue-100/30 dark:bg-blue-900/30 border-blue-500" isReadonly={true} />
                    <SwotColumn title="Threats" category="threats" items={threats} placeholder="" className="bg-yellow-100/30 dark:bg-yellow-900/30 border-yellow-500" isReadonly={true} />
                </div>
            </div>
        </DragDropContext>
    );
