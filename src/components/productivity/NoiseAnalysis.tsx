...
export function NoiseAnalysis() {
    ...
    const noiseContentRef = useRef<HTMLDivElement>(null);
    ...
    const exportToImage = async (format: 'png' | 'pdf') => {
        if (!noiseContentRef.current) return;
        
        const canvas = await html2canvas(noiseContentRef.current, {
            scale: 2,
    ...
    return (
        <div className="w-full max-w-7xl mx-auto p-4 md:p-6 space-y-6">
            <div ref={noiseContentRef} className="p-4 bg-background">
