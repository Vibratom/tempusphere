    ...
    const ExportPreview = () => (
        <div ref={contentRef} className="p-8 bg-background">
             ...
             <div className="grid grid-cols-3 gap-6 items-center">
                <ElementCard title="Strategy" description="The plan to build competitive advantage." value={strategy} icon={Target} className="bg-blue-100/30 dark:bg-blue-900/30 border-blue-500" isReadonly/>
                <ElementCard title="Structure" description="How the company is organized." value={structure} icon={Network} className="bg-green-100/30 dark:bg-green-900/30 border-green-500" isReadonly/>
                <ElementCard title="Systems" description="The daily procedures and processes." value={systems} icon={Cog} className="bg-yellow-100/30 dark:bg-yellow-900/30 border-yellow-500" isReadonly/>
                <ElementCard title="Style" description="The leadership style." value={style} icon={User} className="bg-purple-100/30 dark:bg-purple-900/30 border-purple-500" isReadonly/>
                <ElementCard title="Shared Values" description="The core values of the company." value={sharedValues} icon={Gem} isCenter={true} isReadonly/>
                <ElementCard title="Staff" description="The employees and their capabilities." value={staff} icon={Users} className="bg-orange-100/30 dark:bg-orange-900/30 border-orange-500" isReadonly/>
                <div className="md:col-start-2"><ElementCard title="Skills" description="The actual skills and competencies." value={skills} icon={Brain} className="bg-red-100/30 dark:bg-red-900/30 border-red-500" isReadonly/></div>
            </div>
        </div>
    );
